...
<body>
	...
	<div style="margin-left: 15%;">
		...
		<br> <a class="btn btn-success" href="unconfirmedorders"><fmt:message
				key="Registrate-New-Project" /></a> <br> <br>
	</div>
					...
					<c:choose>
						<c:when test="${order.id==project.orderId}">
							<tr>
								...
								<td>${project.price}</td>
								<td><a href="projectdetails?id=${project.id}"><img
										src="img/icons/edit2icon.png"
